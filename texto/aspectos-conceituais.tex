...
\clearpage
    \item[\gls{mvt}] \hfill \\
        É uma \textit{design pattern} utilizada pelo \textit{framework} \gls{django}. Segundo \citeonline{djangobook}, o \textit{framework} segue boa parte do que é proposto pelo padrão \gls{mvc} proposto por \citeonline{gamma95}, de maneira que ele poderia considerar-se que ele segue o mesmo.\\
