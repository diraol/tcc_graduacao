...
\section{Arquivos do Projeto Django}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% ---
\chapter{Código fonte do Aplicativo Móvel}\label{anexo:sources-mobile}
%% ---
\section{Códigos JavaScript}
\lstinputlisting[language={JavaScript},caption={Arquivo principal do Aplicativo  Móvel}]{./codes/mobile/app.js}
\lstinputlisting[language={JavaScript},caption={\textit{Controllers} do Aplicativo  Móvel}]{./codes/mobile/controllers.js}
\lstinputlisting[language={JavaScript},caption={\textit{Services} do Aplicativo Móvel}]{./codes/mobile/services.js}

\section{Códigos HTML}
\lstinputlisting[language={HTML5},caption={Index do Aplicativo Móvel}]{./codes/mobile/index.html}
\lstinputlisting[language={HTML5},caption={Login do Aplicativo Móvel}]{./codes/mobile/login.html}
\lstinputlisting[language={HTML5},caption={Menu do Aplicativo Móvel}]{./codes/mobile/menu.html}
\lstinputlisting[language={HTML5},caption={Home do Aplicativo Móvel}]{./codes/mobile/main.html}
\lstinputlisting[language={HTML5},caption={do Aplicativo Móvel}]{./codes/mobile/map.html}
\lstinputlisting[language={HTML5},caption={do Aplicativo Móvel}]{./codes/mobile/game.html}
\lstinputlisting[language={HTML5},caption={Página de Seleção do ônibus do Aplicativo Móvel}]{./codes/mobile/avaliacao.html}
\lstinputlisting[language={HTML5},caption={Página de Avaliação Geral do Aplicativo Móvel}]{./codes/mobile/avaliacao_geral.html}
\lstinputlisting[language={HTML5},caption={Página de Avaliação Específica do Aplicativo Móvel}]{./codes/mobile/avaliacao_especifica.html}

\section{Código CSS}
\lstinputlisting[language={CSS},caption={CSS do Aplicativo Móvel}]{./codes/mobile/style.css}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% ---
\chapter{Árvore de arquivos}
\lstinputlisting[language={BASH},caption={Árvore de arquivos do \textit{Backend}}]{./codes/trilhasp_files_tree}
%\clearpage
\lstinputlisting[language={BASH},caption={Árvore de arquivos do Aplicativo Móvel}]{./codes/mobile/files_tree}