...
% ---
% PACOTES
\include{./default/pacotes}
% ---
% CONFIGURAÇÕES DE PACOTES
\include{./default/pacotes-configuracoes}
...
\include{./informacoes-gerais}
% ---

% ---
% Configurações de aparência do PDF final
\include{./default/aparencia-pdf-final}
...
\begin{folhadeaprovacao}
  \begin{center}
   ...
   \assinatura{\textbf{Profa. Dra. Regina Melo Silveira} \\ Convidada}
   \assinatura{\textbf{Prof. Dr. Jorge Rady de Almeida Junior} \\ Convidado}
   %TODO
...
%\input{./texto/planejamento}
\input{./texto/aspectos-conceituais}
\input{./texto/especificacao}
