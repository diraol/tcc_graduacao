...
\newcommand{\criarcasodeuso}{%
    ...
    %\null \\
    %\hrule\ \\
    \hspace{-\parskip}\hspace{-\parindent}\textbf{Caso de uso UC\thenumcasodeuso (\hypertarget{UC\thenumcasodeuso}{uc-\cmdLabelCasodeuso}):}  \cmdNomeCasodeuso\\
    \null \\
...
%Label
\newcommand{\labelCdU}[1]{\renewcommand{\cmdLabelCasodeuso}{#1}}
